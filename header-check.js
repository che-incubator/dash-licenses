...
const CHECK_PATHS = [
  { dir: 'src', exts: ['.ts', '.tsx'], type: 'typescript', description: 'TypeScript source files' },
  { dir: 'tests', exts: ['.ts', '.tsx'], type: 'typescript', description: 'TypeScript test files' },
...
const IGNORE_DIRS = ['node_modules', 'dist', 'coverage', '.git', '.yarn', 'lib'];
